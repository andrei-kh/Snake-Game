...
class Snake(object):
    ...
    def __init__(self):
        self.lenght = 1
        self.positions = [((sett.GRID_WIDTH // 2) * sett.GRID_SIZE,
    ...
    def move(self):
        ...
        x, y = self.direction
        new = (((curr_head_pos[0] + x * sett.GRID_SIZE) % sett.SCREEN_WIDTH),
...
class Food(object):
    ...
    def randomize_position(self, positions=[]):
        while True:
            self.position = (random.randint(0, sett.GRID_WIDTH - 1) * sett.GRID_SIZE,
